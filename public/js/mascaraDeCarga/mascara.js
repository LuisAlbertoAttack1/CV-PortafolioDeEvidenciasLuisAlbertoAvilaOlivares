...
function mascaraObloqueo() {
    $.blockUI({
        ...
        message: ' <img src="https://luisalbertoattack1.github.io/CV-PortafolioDeEvidenciasLuisAlbertoAvilaOlivares/img/LogoPersonal.webp" class="img-fluid" width="300" height="300">',
        css: {
            border: 'none',
            // padding: '15px', 
